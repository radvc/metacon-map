...
const config = [
    {
        zone: 'needHelp',
        message: 'Want to talk to us? We are happy to help you out.',
        cta: [
            {
                label: 'Meet us',
                className: 'primary',
                callback: () => WA.openTab('https://forms.svengroup.com/website-account-firststep.html'),
            }
        ]
    },
    {
        ...
        cta: [
            {
                label: 'Facebook',
                className: 'primary',
                callback: () => WA.openTab('https://www.facebook.com/metacon.ph'),
            },
            {
                label: 'Instagram',
                className: 'primary',
                callback: () => WA.openTab('https://www.instagram.com/metacon.ph'),
            }
        ]
    },
]
